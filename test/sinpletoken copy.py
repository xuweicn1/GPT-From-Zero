...
class SimpleTokenizerV1:
    ...
    def encode(self, text):
        ...
        将输入文本转换为整数列表
        """
        # tokens = text.split()  # 简单的分词方法，可以根据需要改进
        # token_ids = [
        #     self.str_to_init[token] for token in tokens if token in self.str_to_init
        # ]
    ...
    def decode(self, ids):
        ...
        # print(token_ids)
        # print(self.init_to_str)
        # tokens = [
        #     self.init_to_str[token_id]
        #     for token_id in token_ids
        #     if token_id in self.init_to_str
        # ]
